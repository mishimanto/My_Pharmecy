  ...
  return (
    <>
      ...
      <div className="mb-6 flex flex-col gap-3 border border-slate-200 bg-white p-4 sm:flex-row sm:flex-wrap sm:items-center sm:justify-between sm:gap-4 sm:p-6">
        ...
        <Link
          to="/prescriptions"
          className="inline-flex w-full items-center justify-center gap-1 border border-slate-200 px-4 py-2.5 text-sm font-semibold text-slate-700 transition underline hover:text-emerald-700 sm:w-auto sm:border-transparent sm:px-5 sm:py-0"
        >
